...
public class AnalizadorParserLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "ID", "NUMERO", "REALNUM", "CADENA", "COMENTARIO", "ESPACIOS"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'='", "';'", "'entero'", "'real'", "'nulo'", "'booleano'", "'+'", 
			"'-'", "'*'", "'/'", "'>'", "'<'", "'=='", "'!='", "'('", "')'", "'{'", 
			"'}'"
		};
	}
	...
	public AnalizadorParserLexer(CharStream input) {
		super(input);
